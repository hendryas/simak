...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= base_url('assets_chat/css/message/messagestyle.css'); ?>">
	<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
	<script src="https://cdn.jsdelivr.net/npm/pace-js@latest/pace.min.js"></script>
	<link rel="stylesheet" href="<?= base_url('assets_chat/css/message/loading-bar.css'); ?>">
...
<body>
	<section id="main" class="bg-dark">
		<div id="chat_user_list">
			<div id="owner_profile_details">
				<div id="owner_avtar" style="background-image: url('<?= base_url('assets/images/') . $image ?>'); background-size: 100% 100%">
					<div>
						<div id="online"></div>
					</div>
				</div>
		...
		<div id="chatbox">
			<div id="data_container" class="">
				<div id="bg_image"></div>
				<h2 class="mt-0">Halo, Selamat Datang!</h2>
				<p class="text-center my-2">Hubungkan perangkat Anda melalui Internet. <br> Ingatlah bahwa Anda harus memiliki koneksi Internet <br> yang stabil untuk pengalaman yang lebih baik.</p>
			</div>
	...
	<script type="text/javascript" src="<?= base_url('assets_chat/js/message/main.js'); ?>"></script>
</body>
