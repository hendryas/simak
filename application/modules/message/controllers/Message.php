...
class Message extends CI_controller
{
	public function __construct()
	{
		...
		$this->load->model('message/Messagemodel', 'Messagemodel');
	...
	{
		if (isset($_POST['uniq'])) {
			$res = $this->Messagemodel->getBlockUserData($_POST['uniq'], $_SESSION['id']);
			print_r(json_encode($res));
		}
	}
