              ...
              <tbody>
                ...
                <?php foreach ($dataKrs as $data) : ?>
                  <tr class="text-center">
                    ...
                    <td>
                      <a href="#"><span class="badge badge-success waves-effect waves-light" data-toggle="modal" data-target="#newEditModal<?php echo $data['id_krs']; ?>">Edit</span></a>
                      <a class="btn-hapus" href="<?php echo base_url('krs/deleteData/') . encrypt_url($data['id_krs']); ?>"><span class="badge badge-danger waves-effect waves-light ml-3">Delete</span></a>
                    </td>
                  </tr>
                  <?php $no++; ?>
                <?php endforeach; ?>
...
<div class="modal fade" id="newTambahData" tabindex="-1" aria-labelledby="newTambahDataLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url(); ?>krs" method="POST" enctype="multipart/form-data">
...
foreach ($dataKrs as $krs) :  ?>
  <div class="modal fade" id="newEditModal<?php echo $krs['id_krs']; ?>" tabindex="-1" aria-labelledby="newEditModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <form action="<?php echo base_url(); ?>krs/editData" method="POST" enctype="multipart/form-data">
          <input type="hidden" name="id_krs" value="<?php echo $krs['id_krs']; ?>">
          <div class="modal-body">
            <div class="form-group">
              <label for="semester">Semester</label>
              <input type="number" class="form-control" id="semester" name="semester" autocomplete="off" value="<?php echo $krs['semester'] ?>" required>
            </div>
            <div class="form-group">
              <label for="sks">SKS</label>
              <input type="number" class="form-control" id="sks" name="sks" autocomplete="off" value="<?php echo $krs['sks'] ?>" required>
            </div>
            <div class="form-group">
              <label for="file_upload">Upload File</label>
              <input class="form-control" type="file" accept="application/pdf" placeholder="Input File" name="file_upload" id="file_upload">
              <small class="text-red"><?php echo $krs['file_upload'] ?></small>
            </div>
