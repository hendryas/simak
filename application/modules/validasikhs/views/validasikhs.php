              ...
              <tbody>
                ...
                <?php foreach ($dataKhs as $data) : ?>
                  <tr class="text-center">
                    ...
                    <td>
                      <?php
                      $checkDataUpload = $this->Validasikhs_model->checkDataUpload($data['id_khs'])->row_array();
                      ?>

                      <?php if ($checkDataUpload != true) : ?>
                        <a href="#"><span class="badge badge-success waves-effect waves-light" data-toggle="modal" data-target="#newEditModal<?php echo $data['id_khs']; ?>">Upload</span></a>
                      <?php else : ?>
  ...
  <div class="modal fade" id="newEditModal<?php echo $khs['id_khs']; ?>" tabindex="-1" aria-labelledby="newEditModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="<?php echo base_url(); ?>validasikhs/editData" method="POST" enctype="multipart/form-data">
